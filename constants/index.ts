export const navLinks: Array<{ label: string }> = [
  { label: 'Store' },
  { label: 'Mac' },
  { label: 'iPhone' },
  { label: 'Watch' },
...
export const performanceImages: Array<{ id: string; src: string }> = [
...
export const performanceImgPositions: Array<{
  id: string;
  left?: number;
  right?: number;
  bottom?: number;
...
export const featureSequence: Array<{
  videoPath: string;
  boxClass: string;
  delay: number;
}> = [
...
export const footerLinks: Array<{ label: string; link: string }> = [
